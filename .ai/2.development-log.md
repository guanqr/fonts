...
### v5.1.0 - English/Monospace Font Support
**Date**: June 13, 2026

Expanded font coverage with monospace developer font:

#### New Font
- **JetBrains Mono**: Added JetBrains Mono monospace font for code display and developer use cases
- **Font Configuration**: Created `src/config/fonts/english.ts` for English/monospace font definitions
- **License**: SIL Open Font License 1.1, suitable for both personal and commercial use

#### Configuration Updates
- Added `english.ts` font configuration module
- Updated font index to combine Chinese, English, and Variable font collections
- JetBrains Mono sourced from GitHub repository files

#### Documentation
- Updated all documentation to reflect new font support
- Added JetBrains Mono to license documentation and README generation

**Migration Status**: ✅ Complete and Production Ready with v5.1.0 English/Monospace Font Support
