...
- **Repository Monitoring**: Track commits for Amstelvar and JetBrains Mono (no releases available)
...
### English / Monospace Fonts

#### JetBrains Mono (jetbrainsmono)
- **Source Repository**: [JetBrains/JetBrainsMono](https://github.com/JetBrains/JetBrainsMono)
- **Font Type**: Monospace developer font
- **Font Weight**: 400 (Regular)
- **License**: SIL Open Font License 1.1
...
- **File Pattern**: `JetBrainsMono-Regular.ttf`
- **Character Sets**: Latin, Cyrillic, symbols, programming ligatures
- **Processing Strategy**: Size-based chunking optimized for code and Latin text
- **Target Chunk Size**: 60KB for optimal loading performance
